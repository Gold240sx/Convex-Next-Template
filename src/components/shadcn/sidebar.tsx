      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            ...
            <div className="flex h-full w-full flex-col bg-gray-100 text-white dark:bg-gray-900">
              {children}
            </div>
          </SheetContent>
        </Sheet>
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(
        "mt-auto flex flex-col gap-2 border-t bg-inherit p-2",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn("flex-1 overflow-y-auto", "flex flex-col gap-2", className)}
      {...props}
    />
  );
});
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    data-sidebar="menu"
    className={cn(
      "scrollbar-hide flex h-fit w-full min-w-0 flex-col gap-1 overflow-y-scroll pb-[180px]",
      className,
    )}
    {...props}
  />
